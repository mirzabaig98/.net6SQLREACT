...
namespace mysecondapp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            using (var connection = new SqlConnection("Server =C2KK9W1\\SQLEXPRESS; Database = Employees; Integrated Security = True;")) // Update the connection string for SQL Server
            {
